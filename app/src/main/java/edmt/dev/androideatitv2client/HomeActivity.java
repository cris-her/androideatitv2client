...
import edmt.dev.androideatitv2client.EventBus.BestDealItemClick;
import edmt.dev.androideatitv2client.EventBus.CategoryClick;
import edmt.dev.androideatitv2client.EventBus.CounterCartEvent;
import edmt.dev.androideatitv2client.EventBus.FoodItemClick;
...
import edmt.dev.androideatitv2client.EventBus.MenuItemEvent;
import edmt.dev.androideatitv2client.EventBus.PopularCategoryClick;
        ...
        builder.setNegativeButton("CANCEL", (dialogInterface, i) -> {
            ...
            if(ckb_news.isChecked())
            {
                ...
                FirebaseMessaging.getInstance()
                        ...
                        .addOnFailureListener(e -> Toast.makeText(HomeActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show()).addOnSuccessListener(aVoid -> Toast.makeText(HomeActivity.this, "Subscribe successfully!", Toast.LENGTH_SHORT).show());
            }
            else
            {
                ...
                FirebaseMessaging.getInstance()
                        ...
                        .addOnFailureListener(e -> Toast.makeText(HomeActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show()).addOnSuccessListener(aVoid -> Toast.makeText(HomeActivity.this, "Unsubscribe successfully!", Toast.LENGTH_SHORT).show());
